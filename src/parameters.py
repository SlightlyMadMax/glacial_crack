...
end_time = 3600.0*24*1/t_0  # Конечное время
dt = 120.0/t_0  # Шаг по времени

N_t = int(end_time/dt)  # Число шагов по времени


gamma = L*rho_ice/(t_0*T_0*k_ice)  # Параметр, используемый в условии Стефана в новых координатах.
