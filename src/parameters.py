...
t_0 = (c_ice*999.84*W*W)/k_ice
end_time = 3600.0*24*36/t_0  # Конечное время
dt = 180.0/t_0  # Шаг по времени

N_t = int(end_time/dt)  # Число шагов по времени


gamma = L/(2097.0*W*W*T_0)  # Параметр, используемый в условии Стефана в новых координатах.
